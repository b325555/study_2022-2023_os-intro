...
author: "Тураева Оиша Муслимовна"
...
![выполнение команды](image/8.png){#fig:009 width=70%}

9. Определим индефикатор процесса с помощью команды ps 

![выполнение команды](image/8.png){#fig:010 width=70%}

10. Изучим команду kill и с помощью неё прекратим gedit

![выполнение команды](image/9.png){#fig:011 width=70%}

![выполнение команды](image/10.png){#fig:012 width=70%}

11. Изучим и выполним команды df и du
![изучим с помощью man](image/11.png){#fig:013 width=70%}

![man df](image/12.png){#fig:014 width=70%}

![man du](image/13.png){#fig:015 width=70%}

![выполнение команды df](image/14.png){#fig:016 width=70%}

12. С помощью команды find выведем именя всех директорий 
![выполнение команды](image/15.png){#fig:017 width=70%}
![выполнение команды](image/16.png){#fig:018 width=70%}
